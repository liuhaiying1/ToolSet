...
public  class TraceListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (getItemViewType(position) == TYPE_TOP) {
            ...
            // 字体颜色加深
            holder.tvAcceptTime.setTextColor(context.getResources().getColor(R.color.RoyalBlue1));
            holder.tvAcceptStation.setTextColor(context.getResources().getColor(R.color.RoyalBlue1));
